                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <form action="{{ route('rentProduct', $advertisement->id) }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input type="date" id="start_date" min="{{$today->format('Y-m-d')}}" max="{{$maxDate}}" name="start_date"
                        ...
                        @elseif ($today < $renting->start_date)
                            <p>
                                {{ __('advertisements.already_rented') }} {{ $renting->start_date->format('Y-m-d') }}
                            </p>
                            @else
                            <form action="{{ route('returnRental', $advertisement->id) }}" method="post" class="space-y-6" enctype="multipart/form-data">
                                @csrf

                                <div>
                                    <label for="img_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('advertisements.return_image') }}</label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="file" name="img_url" id="img_url" accept=".jpg, .jpeg, .png, image/gif" required
                                ...
                                <div>
                                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                        {{ __('advertisements.return_rental') }}
                                    </button>
                                </div>
                            </form>
                            @endif
